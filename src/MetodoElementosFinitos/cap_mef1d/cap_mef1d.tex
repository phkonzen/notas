...
\hl{Interpolação é uma técnica de aproximação de funções}. Dada uma função contínua $f$ em $I=[x_0, x_1]$, definimos o \hlemph{operador de interpolação linear} $\pi: C^0(I)\to P_1(I)$ por
\begin{equation}\hleq
