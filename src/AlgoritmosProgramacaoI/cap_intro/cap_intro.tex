...
A \emph{linha de comando} executada acima pede ao computador para imprimir no \lstinline+prompt de saída+ a frase \lstinline+Olá, mundo!+. O \emph{método} \href{https://docs.python.org/3/library/functions.html}{\lstinline+print+}\endnote{Consulte na \textit{web} \href{https://docs.python.org/3/library/functions.html}{The Python Standard Library: Built-in Functions: print}.} contém instruções para imprimir \emph{objetos} em um dispositivo de saída, no caso, imprime a frase na tela do computador.
