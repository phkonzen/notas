...
\begin{obs}[\hl{Mulher na Matemática}]
...
\begin{obs}[\hl{Identificadores Reservados}]
...
\begin{ex}[\hl{Permutação de Variáveis/Identificadores}]\label{cap_lingua_sec_dados:ex:trocaVar}
...
\begin{obs}[\hl{Espaços entre Operandos}]
...
\begin{obs}[\hl{Precedência de Operações}]
...
\begin{obs}[\hl{Igualdade entre \texttt{tuples}}]
...
\begin{ex}[\hl{Vetores Alocados como \texttt{lists}}]
...
\begin{ex}[\hl{Matrizes e Listas Encadeadas}]
