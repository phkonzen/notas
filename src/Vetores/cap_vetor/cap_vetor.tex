...
\begin{exer}\label{exer:vetor_prob_01}
  Na figura \ref{fig:exer_vetor_prob_01}, temos $\vec{u} = \overrightarrow{GJ}$ e $\vec{v} = \overrightarrow{AK}$. Assim sendo, escreva os vetores $\overrightarrow{RS}$, $\overrightarrow{NI}$, $\overrightarrow{AG}$, $\overrightarrow{NQ}$, $\overrightarrow{AT}$ e $\overrightarrow{PE}$ em função de $\vec{u}$ e $\vec{v}$.

  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{./cap_vetor/dados/fig_exer_prob_01/fig_exer_prob_01}
    \caption{Referente ao Exercício \ref{exer:vetor_prob_01}.}
    \label{fig:exer_vetor_prob_01}
  \end{figure}
\end{exer}

\begin{exer}\label{exer:vetor_prob_02}
  Sejam $\overrightarrow{CA}$, $\overrightarrow{CM}$ e $\overrightarrow{CB}$ os vetores indicados na Figura \ref{fig:exer_vetor_prob_02}. Mostre que $\overrightarrow{CM} = \frac{1}{2}\overrightarrow{CA} + \frac{1}{2}\overrightarrow{CB}$.

  \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./cap_vetor/dados/fig_exer_prob_02/fig_exer_prob_02}
    \caption{Referente ao Exercício \ref{exer:vetor_prob_02}.}
    \label{fig:exer_vetor_prob_02}
  \end{figure}
\end{exer}
\begin{resp}
