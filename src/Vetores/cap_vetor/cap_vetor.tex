...
\begin{resol}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[max width=0.9\textwidth, max height=6in]{./cap_vetor/dados/fig_exeresol_paralelogramo/fig.png}
...
\begin{resp}
  ...
  \includegraphics[max width=0.9\textwidth, max height=6in]{./cap_vetor/dados/fig_exer_segs_dif_normas/fig.png}
\end{resp}
...
\begin{resp}
  ...
  \includegraphics[max width=0.9\textwidth, max height=6in]{./cap_vetor/dados/fig_exer_segs_nems/fig.png}
\end{resp}
...
\begin{resp}
  ...
  \includegraphics[max width=0.9\textwidth, max height=6in]{./cap_vetor/dados/fig_exer_segs_hn_s/fig.png}
\end{resp}
...
\begin{exer}
  Mostre que dois segmentos orientados $\overrightarrow{AB}$ e $\overrightarrow{CD}$ são equipolentes se, e somente se, os pontos médios de $AD$ e $BC$ são coincidentes.
\end{exer}
\begin{resp}
