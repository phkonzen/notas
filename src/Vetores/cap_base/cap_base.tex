...
\subsubsection{Combinação Linear de um Vetor}
...
\begin{proposicao}\normalfont{(\hl{Combinação Linear entre Dois Vetores}.)}\label{cap_base_sec_comblin:prop:comb2vet}
...
\begin{proposicao}\normalfont{(\hl{Combinação Linear entre Três Vetores}.)}\label{cap_base_sec_comblin:prop:comb3vet}
...
\begin{ex}\label{ex:deplinear}
  No exemplo anterior \exerref{cap_base_sec_comblin:ex:comblinear}, temos:
  \begin{enumerate}[a)]
