...
\begin{ex}
  ...
  \ifispython
  Podemos usar o \verb+SymPy+ para manipularmos vetores em coordenadas. Para computarmos a soma neste exemplo, podemos usar os seguintes comandos\footnote{Veja a Observação \ref{obs:cap_base_python} no ínicio deste capítulo.}:
\begin{verbatim}
u = Matrix([2,-1,-3])
v = Matrix([-1,4,-5])
u+v
