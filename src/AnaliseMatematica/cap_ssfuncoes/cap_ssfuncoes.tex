...
\chapter{Sequências e séries de funções}\label{c_ssf}\index{sequência de funções}\index{séries de funções}
\thispagestyle{fancy}

\section{Sequência de funções}\label{c_ssf_s_sf}\index{sequência de funções}
...
\section{Algumas consequências da convergência uniforme}\label{c_ssf_s_conseq_convu}
...
\section{Séries de funções}\label{c_ssf_s_serf}\index{séries de!funções}
