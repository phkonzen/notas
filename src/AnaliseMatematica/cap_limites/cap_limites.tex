...
\chapter{Limites}\label{c_lim}\index{limites!de funções}
\thispagestyle{fancy}

\section{Noções de topologia}\label{c_lin_s_nocoes_top}
...
\section{Limites}\label{c_lin_s_lim}\index{limite}
...
\section{Limites laterais}\label{c_lin_s_lim_lat}
...
\section{Limites no infinito e limites infinitos}\label{c_lin_s_lim_inf}
