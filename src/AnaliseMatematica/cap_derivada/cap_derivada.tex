...
\chapter{Diferenciação}\label{c_dif}\index{diferenciação}
\thispagestyle{fancy}

\section{Derivada}\label{c_dif_s_der}\index{derivada}
...
\section{Regras operacionais}\label{c_dif_s_regras}
...
\section{Extremos e o teorema do valor médio}\label{c_dif_extremos}
