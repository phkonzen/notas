...
\chapter{Continuidade}\label{c_cont}\index{continuidade}
\thispagestyle{fancy}

\section{Função contínua}\label{c_cont_s_f_continua}\index{função!contínua}
...
\section{Propriedades de funções contínuas}\label{c_cont_s_prop_f_cont}
...
\section{Continuidade uniforme}\label{c_cont_s_cont_unif}\index{continuidade!uniforme}
