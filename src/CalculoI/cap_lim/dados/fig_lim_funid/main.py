...
ax.text(-0.2,x0-0.05,"$L$")
ax.plot([x0],[x0],marker="o",markersize=6,markeredgecolor="red",markerfacecolor="0.85")
ax.text(2.5+0.2,2.5,"$y=x$")
fig.savefig('fig_lim_funid.png', bbox_inches='tight',transparent=True)
