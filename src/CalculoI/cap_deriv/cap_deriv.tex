...
\begin{ex}
  ...
  \begin{align}
    [\sen(\ln x^2)] &= \cos(\ln x^2)\cdot[\ln x^2]' \\
                    ...
                    &= \frac{2}{x}\cos(\ln x^2).
  \end{align}
  A função $y = x^2$ é derivável em toda parte. Sendo a função logaritmo derivável para todo $x>0$, temos que $y = \ln x^2$ é derivável para todo $x>0$. Por fim, como a função seno é derivável em toda parte, concluímos que $f$ é derivável para todo $x>0$.
...
\begin{ex}
  A regra da cadeia aplicação a derivada da função potência é
  \begin{equation}
