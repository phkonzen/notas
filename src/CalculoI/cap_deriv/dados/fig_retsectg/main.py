...
ax.plot([x0],[y0],marker="o",markersize=6,color="blue")
ax.plot([x1],[y1],marker="o",markersize=6,color="blue")
...
ax.text(x0+0.2,y0-0.125,'$x_1-x_0$')
ax.text(x1-0.7,y1+0.2,'reta tangente')
