...
Outra forma matricial de representar o sistema \eqref{eq:sl_fa_1}-\eqref{eq:sl_fa_n} é pela chamada mattriz estendida
\begin{equation}
  E = [A ~\pmb{b}].
\end{equation}
...
\begin{align}
  ...
  3x_4 &= 3.
\end{align}
Resulvendo da última equação para a primeira, temos
\begin{align}
  x_4 &= 1,\\
  x_3 &= 0,\\
