...
\begin{equation}
  w_i = \frac{(L_{n-1},L_{n-1})}{L_{n-1}(x_i)\left[L_{N}'(x_i)\right]},~i=1, 2, \dotsc, n.
\end{equation}

\begin{ex}\label{ex:GLa}
  Na Tabela~\ref{tab:ex_GLa}, temos as aproximações $\tilde{I}$ da integral $I = \int_0^\infty xe^{-x}\,dx$ obtidas pela quadratura de Gauss-Laguerre com diferentes pontos $n$.
