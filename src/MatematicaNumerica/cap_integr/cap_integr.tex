...
\begin{resp}
  ...
  \fi
  a)~$3,33647zE-1$; b)~$1,71368\E-1$; c)~$2,79554\E-1$
\end{resp}
...
\end{equation}
onde $a=x_1 < x_2 < \cdots < x_{n+1}=b$. Então, a aplicação de uma quadratura em cada integral em $[x_i, x_{i+1}]$, $i=1, 2, \dotsc, n$, acaba por nos fornecendo uma regra composta.
