...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_bis_intro/fig.png}
  \caption{Função $f$ do Exemplo~\ref{cap_eq1d_sec_bissec:ex:bis_intro}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_bis_multpar/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_falsapos/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_pfixo/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_ex_pfixo_intro/fig.png}
  \caption{Funções $f$, $g_1$ e $g_2$ do Exemplo~\ref{cap_eq1d_sec_pfixo:ex:pfixo_intro}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_pfixo_interp/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_ex_pfixo_exec/fig.png}
  \caption{Gráficos de $g$ e $|g'|$ discutidas no Exemplo~\ref{cap_eq1d_sec_pfixo:ex:pfixo_exec}.}
...
\begin{ex}\label{cap_eq1d_sec_newton:ex:newton}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=4in]{./cap_eq1d/dados/fig_newton_ex/fig.png}
    \caption{Função $f$ do Exemplo~\ref{cap_eq1d_sec_newton:ex:newton}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_Newton_geointerp/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_newton_ex_init/fig.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{./cap_eq1d/dados/fig_secante_geointerp/fig.png}
