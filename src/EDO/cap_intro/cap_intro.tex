...
\ifispython
\begin{obs}\label{obs:cap_intro_python}
Ao longo do capítulo, contaremos com o suporte de alguns códigos \python~ com o seguinte preâmbulo:
\begin{verbatim}
from sympy import *
\end{verbatim}
\end{obs}
...
\begin{ex}
  ...
  \ifispython
  No \python\footnote{Veja a Observação \ref{obs:cap_intro_python}}, podemos usar:
\begin{verbatim}
In : t = symbols('t')
