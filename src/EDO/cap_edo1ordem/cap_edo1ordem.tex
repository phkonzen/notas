...
\begin{align}
  ...
  y &= ce^{-at},
\end{align}
onde $c$ é uma constante indeterminada. Observamos que, tomando $c=0$, esta última equação também engloba a solução trivial $y(t)\equiv 0$.

Concluímos que a \emph{solução geral} de \eqref{eq:edo1linear_pc_g0} é
\begin{equation}
