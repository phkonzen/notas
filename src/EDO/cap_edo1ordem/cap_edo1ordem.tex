...
\begin{flushright}
  \href{https://archive.org/details/edo-ordem-1-linear}{$\blacktriangleright$ \bf Vídeo disponível!}
\end{flushright}
...
\begin{flushright}
  \href{https://archive.org/details/edo-ordem-1-separavel}{$\blacktriangleright$ \bf Vídeo disponível!}
\end{flushright}
