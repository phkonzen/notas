...
Os parâmetros $u_1$, $u_2$, $\dotsc$, $u_n$ devem ser escolhidos de forma que $y_p$ satistafaça \eqref{eq:edolin_on_varpar}. Quando $n>1$, temos um problema subdeterminado (mais variáveis que equações). Para fechar o problema, exigimos que os parâmetros sejam tais que
\begin{align}
...
\end{align}
Com isso, ao subtituirmos $y_p$ em \eqref{eq:edolin_on_varpar}, obtemos
\begin{align}
