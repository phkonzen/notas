...
\begin{ex}\label{ex:edolin_on_h}
  ...
  \begin{align}
    ...
    &\underline{-r^3 + r^2}~~~~~~~~~~~~~{\color{cyan}r^2+3r+2}\\
    &~~~~~~~~3r^2 - r\\
    &~~~~~~\underline{-3r^2 + 3r}\\
    &~~~~~~~~~~~~~~2r - 2\\
    &~~~~~~~~~~~~\underline{-2r + 2}\\
  ...
  \end{gather}
  Conbcluímos que as soluções da equação característica são ${\color{red}r_1 = -2}$, ${\color{red}r_2 = -1}$ e ${\color{red}r_3=1}$. Logo, a \emph{solução geral} é
  \begin{equation}
