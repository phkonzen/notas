...
As notas de \emph{Equações Diferenciais Ordinárias} abordam tópicos introdutórios sobre equações diferenciais ordinárias. Como ferramenta computacional de apoio, exemplos de aplicação de códigos {python} são apresentados, mais especificamente, códigos com suporte da biblioteca de matemática simbólica {sympy}.
