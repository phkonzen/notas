...
\section{EDO não homogênea}\label{cap_edo2ordem_sec_eqnh}
...
\begin{exer}
  ...
  Supondo que $\gamma^2-4mk = 0$, calcule
  \begin{equation}
    \lim_{t\to 0} s(t).
  \end{equation}
\end{exer}
\begin{resp}
  $\displaystyle \frac{1}{\gamma^2 + (k-m)^2}\left(\frac{k-m}{\gamma}\cos(t) + \sen(t)\right)$
\end{resp}
