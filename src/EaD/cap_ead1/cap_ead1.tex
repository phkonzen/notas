...
Introduzimos pontos de equilíbrio na Seção \ref{cap_ead1_sec_eael} e, aqui, vamos estudá-los no contexto de equação a diferenças de primeira ordem e não lineares.

Um dos primeiros aspectos a serem notados é que equação não lineares podem ter vários pontos de equilíbrio, ter somente um ou não ter.
