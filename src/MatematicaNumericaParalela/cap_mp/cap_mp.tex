...
\section{Comandos básicos}\label{cap_mp_sec_cb}
...
\end{equation}
em paralelo com $np$ {\it threads}. Começamos analizando o seguinte código
...
#pragma omp for
\end{verbatim}
Com este construtor, o laço do somatório pode ser automáticamente distribuindo entre os {\it threads}. Verifique o seguinte código!
...
\end{exeresol}
\begin{resol}
  Embora podería-se esperar que o valor impresso seria o $0$ (o \verb+id+ do {\it master thread}), isso não necessariamente ocorre. O valor impresso será $10$, aquele que foi alocado na variável \verb+tid+ antes da região paralela ser inicializada.
\end{resol}
