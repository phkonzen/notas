...
\begin{teo}\normalfont{(Unicidade de séries de potências)}\label{teo:ser_pot_unicidade}
  Sejam $\sum a_nx^n$ e $\sum b_nx^n$ duas séries de potências com raio de convergência $r$. Se Se $\sum a_nx^n = \sum b_nx^n$ para todo $x$ tal que $|x|<r$, então $a_n=b_n$ para todo $n$.
\end{teo}
\begin{dem}
