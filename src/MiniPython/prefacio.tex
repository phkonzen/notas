...
As notas do \emph{Minicurso de Python para Matemática} fazem uma introdução sobre os elementos da linguagem {\python}, da programação estruturada, da computação matricial e de gráficos. É pensada para estudantes de cursos de matemática e áreas afins.
