...
\begin{ex}
  Vamos determinar ângulo entre os vetores $\displaystyle \vec{u}=\left(\sqrt{\frac{{3}{2}},\frac{1}{2},1\right)$ e $\displaystyle \vec{u}=\left(\frac{1}{2},\sqrt{\frac{3}{2}},-1\right)$. Da Proposição \ref{prop:angulo_prodesc}, temos
    \begin{equation}
