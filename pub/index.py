...
class Index:
    ...
    def add_body(self):
        ...
        body += '<a href="https://www.ufrgs.br/ppgmap/?page_id=236">PPGMAp - UFRGS: Seleção de Mestrado 2022/2 !</a>\n'
        body += '</div>\n\n'
        ...
        body += '<div class="carousel-item">\n'
        body += '<div class="spinner-grow spinner-grow-sm text-danger mb-1" role="status"></div>\n'
        body += '<a href="https://eventos.fgv.br/laciam-2023">LACIAM 2023: Chamada de Trabalhos !</a>\n'
        body += '</div>\n\n'
        ...
        body += '<a href="./MatematicaNumericaAvancada/main.html" class="btn btn-primary">\n'
        body += 'Abrir</a>\n'
        body += '</div>\n'
        body += '</div>\n'
        body += '</div>\n\n'
        ...
        body += '<div class="card border-warning mb-3" style="width: 20rem;">\n'
        body += '<div class="card-header bg-warning">Notas de Aula <span class="badge bg-secondary">C/C++</span></div>\n'
        body += '<div class="card-body">\n'
        ...
        body += '<a href="./MatematicaNumericaParalela/main.html" class="btn btn-warning">\n'
        body += 'Abrir</a>\n'
        body += '</div>\n'
        body += '</div>\n'
        body += '</div>\n\n'
        ...
        body += '<div class="card border-warning mb-3" style="width: 20rem;">\n'
        body += '<div class="card-header bg-warning">Minicurso <span class="badge bg-secondary">Python</span></div>\n'
        body += '<div class="card-body">\n'
        ...
        body += '<a href="./MiniPython/main.html" class="btn btn-warning">\n'
        body += 'Abrir</a>\n'
        body += '</div>\n'
        body += '</div>\n'
        body += '</div>\n\n'
