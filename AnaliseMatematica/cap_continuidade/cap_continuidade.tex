...
\begin{teo}\normalfont{Teorema do valor intermediário}\label{teo:valor_intermediário}\index{Teorema do!valor intermediário}
...
\begin{lem}\label{lem:função_contínua_limitada}
...
\end{teo}
\begin{dem}
  Do Teorema~\ref{teo:função_contínua_valores_extremos} sejam $m$ e $M$ os valores mínimo e máximo de $f$, respectivamente. Logo, $f(I) \subset [m, M]$. Agora, sejam $c,d\in I$ tal que $f(c)=m$ e $f(d)=M$. Pelo Teorema do valor intermediário\index{teorema!do valor intermediário}, dado qualquer $d\in [m, M]$ existe $x\in I$ tal que $f(x)=d$, i.e. $d\in f(I)$. Portanto, $[m, M]\subset f(I)$.
\end{dem}
...
\end{exer}
\begin{resp}
  Use o Teorema do valor intermediário\index{teorema!do valor intermediário}.
\end{resp}
